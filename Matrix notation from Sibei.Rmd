...
$$l(\mathbf Y,\boldsymbol\beta)=\sum_{i=1}^n(y_i\mathbf x_i\boldsymbol \beta-log(1+e^{\mathbf x_i\boldsymbol \beta}))\\=Y^T\mathbf X\boldsymbol \beta-n\times log(1+e^{\mathbf X\boldsymbol \beta}))$$
