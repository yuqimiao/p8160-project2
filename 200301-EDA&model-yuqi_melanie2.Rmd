...
cancer_package$diagnosis <- ifelse(cancer_package$diagnosis == 1, "M", "B")
...
cancer$diagnosis <- ifelse(cancer$diagnosis == 1, "M", "B")
...
coef(lasso.fit$finalModel, lasso.fit$bestTune$lambda)
coef(lasso.fit$finalModel, 0.030303)
