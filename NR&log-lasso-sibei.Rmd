...
# working stuff
quadratic_appro = function(beta_vec,lambda){
  x = x_matrix
  y = y_matrix
  ...
  for (i in 1:11){
    ...
    beta_update=c(beta_pre[1:i-1],beta[i],beta_pre[i+1:11])
    i=i+1
  }
  return(beta_update)
}
...
quadratic_appro(beta_1,lambdas[2])
