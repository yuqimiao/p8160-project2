...
>>>>>>> 323e4c1e0339241753a6c13d1dc458a4b3fd6966
...
After doing the Newton-Raphson modified with step and direction, the estimation of 10 coefficients of means are in table 1 which are consistant with the results from glm function. When mean, SD and largest values of 30 features are included, the estimation of all 30 features are in Supplementary table1.
